                                ...
                                <tr key={btiq.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-2">
                                        <div className="flex justify-center gap-8 text-xs">
                                            ...
                                            <button type="button" onClick={() => setDeleteForm(true)}
...
const DeleteForm = ({ onClose, title }) => {
    const [isOpen, setIsOpen] = useState(false);

    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Illum explicabo velit dolorum at adipisci,
            alias ut incidunt ipsa nulla iure ad quas nisi sunt voluptate corporis obcaecati eligendi ratione. Non?
        </Modal>
    )
}
